...
const camposDetalhados: Record<TipoUltrassom, CampoDefinicao[]> = {
  ...
  ultrassom_obstetrico: [
    ...
    { nome: "percentilPeso", descricao: "Percentil do peso fetal estimado", exemplo: "26,2", regra: "MUITO IMPORTANTE para acompanhamento do crescimento fetal. Procure por: 'percentil X', 'pX', 'p X', 'no percentil X para a idade gestacional', 'peso fetal no percentil X', 'PFE percentil X', 'percentil de peso X'. Extraia APENAS o valor numérico (ex: '26,2' de 'percentil 26,2'). Use vírgula como separador decimal se o laudo usar vírgula. Se o laudo diz 'adequado para IG' ou 'AIG' sem número, retorne 'AIG'. Se diz 'PIG' ou 'pequeno para IG', retorne 'PIG'. Se diz 'GIG' ou 'grande para IG', retorne 'GIG'." },
  ...
  morfologico_2tri: [
    ...
    { nome: "percentilPeso", descricao: "Percentil do peso fetal estimado", exemplo: "22,0", regra: "MUITO IMPORTANTE para acompanhamento do crescimento fetal. Procure por: 'percentil X', 'pX', 'p X', 'no percentil X para a idade gestacional', 'peso fetal no percentil X', 'PFE percentil X', 'percentil de peso X'. Extraia APENAS o valor numérico (ex: '22,0' de 'percentil 22,0'). Use vírgula como separador decimal se o laudo usar vírgula. Se o laudo diz 'adequado para IG' ou 'AIG' sem número, retorne 'AIG'. Se diz 'PIG' ou 'pequeno para IG', retorne 'PIG'. Se diz 'GIG' ou 'grande para IG', retorne 'GIG'." },
    { nome: "circunferenciaAbdominal", descricao: "Circunferência abdominal fetal (CA) - valor isolado", exemplo: "175 mm", regra: "Procure por 'CA', 'circunferência abdominal', 'abdominal circumference', 'AC'. Extraia o valor numérico com a unidade (mm ou cm). Se estiver em cm, mantenha a unidade para que o sistema converta. Não repita o valor no campo biometria se já extraiu aqui." },
  ...
  ultrassom_seguimento: [
    ...
    { nome: "percentilPeso", descricao: "Percentil do peso fetal estimado", exemplo: "5,3", regra: "MUITO IMPORTANTE para acompanhamento do crescimento fetal. Procure por: 'percentil X', 'pX', 'p X', 'no percentil X para a idade gestacional', 'peso fetal no percentil X', 'PFE percentil X', 'percentil de peso X'. Extraia APENAS o valor numérico (ex: '5,3' de 'percentil 5,3'). Use vírgula como separador decimal se o laudo usar vírgula. Se o laudo diz 'adequado para IG' ou 'AIG' sem número, retorne 'AIG'. Se diz 'PIG' ou 'pequeno para IG', retorne 'PIG'. Se diz 'GIG' ou 'grande para IG', retorne 'GIG'. Também procure na hipótese diagnóstica: 'Peso fetal no percentil X', 'CIUR' (retorne o percentil se mencionado)." },
