...
const camposDetalhados: Record<TipoUltrassom, CampoDefinicao[]> = {
  ...
  ultrassom_obstetrico: [
    ...
    { nome: "placentaDistanciaOI", descricao: "Distância da placenta ao orifício interno do colo", exemplo: "5 cm", regra: "Procure por 'distância ao OI', 'orifício interno'. Se 'longe do OI' ou 'não atinge o OI', retorne isso." },
    { nome: "coloUterinoTV", descricao: "Se foi realizada avaliação do colo por via transvaginal", exemplo: "Sim", regra: "Procure por 'via transvaginal', 'TV', 'cervicometria'. Se medida do colo presente, retorne 'Sim'." },
    { nome: "coloUterinoMedida", descricao: "Medida do colo uterino em mm", exemplo: "35 mm", regra: "Procure por 'colo uterino', 'cervicometria', 'colo medindo'. Valor em mm." },
