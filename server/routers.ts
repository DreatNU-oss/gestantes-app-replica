...
export const appRouter = router({
  ...
  historicoTextos: router({
    ...
    getSugestoes: protectedProcedure
      .input(z.object({
        tipo: z.enum(["observacao", "conduta_complementacao", "historia_patologica", "historia_social", "historia_familiar", "us_biometria", "us_avaliacao_anatomica", "us_observacoes", "eco_conclusao", "us_seguimento_observacoes"]),
