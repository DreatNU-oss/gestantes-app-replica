...
import { configuracoesEmail, resultadosExames, historicoInterpretacoes, feedbackInterpretacoes, gestantes, arquivosExames, type InsertResultadoExame, type InsertHistoricoInterpretacao, type InsertFeedbackInterpretacao, type InsertArquivoExame } from '../drizzle/schema';
...
export const appRouter = router({
  ...
  gestantes: router({
    ...
    create: protectedProcedure
      .input(z.object({
        ...
        hospitalParto: z.string().optional(),
        convenioCirurgia: z.string().optional(),
      ...
      .mutation(async ({ ctx, input }) => {
        const data: any = {
          ...
          hospitalParto: input.hospitalParto || null,
  ...
  email: router({
    ...
    // [REMOVIDO] processarLembretes, logs, historico, estatisticas, proximosLembretes
    // Envio automático de e-mails desativado. Mantido apenas configurar/obterConfig para envio manual.
  }),
      ...
      .mutation(async ({ input }) => {
        ...
        const dadosPdf = {
          ...
          consultas: consultas.map((c: any) => ({
            ...
            au: c.alturaUterina != null ? Math.round(c.alturaUterina / 10) : null,
            bcf: c.bcf,
