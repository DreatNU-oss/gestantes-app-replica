...
## Refatorar agendamento de cesárea no Cartão de Pré-natal (23/02/2026) — CONCLUÍDO
...
- [x] Criar visualização de quais gestantes acessaram o app mobile (fizeram download e login)
- [x] Identificar no banco de dados os registros de autenticação/acesso das gestantes ao app
